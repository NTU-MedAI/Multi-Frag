...
def get_dgl_node_feature(mol):
    ...
    * **One hot encoding of the number of total Hs on the atom**. The supported possibilities
    ...
    #         coords1.append(atom_coords.x)
    #         coords1.append(atom_coords.y)
    #         coords1.append(atom_coords.z)
    #         coords.append(coords1)
    #         coords1 = []
    #     feats['h'] = np.array(feats['h'])
    #     coords = np.array(coords)
    #     feats['h'] = np.append(feats['h'],coords,axis=1)
    #     feats['h'] = torch.Tensor(feats['h'])
    # except:
    #     atom_num = mol.GetNumAtoms()
    #     atom_arry = np.full((atom_num,3),0)
    #     feats['h'] = np.append(feats['h'], atom_arry, axis=1)
    #     feats['h'] = torch.Tensor(feats['h'])
    return feats['h']
