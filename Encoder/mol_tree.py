...
def get_Vocab_df(data_name,df): #对使用树分解后的分子的官能团簇写入词汇表 vocabulary.txt

    if output_path is None:
        output_path = './dataset' + '/vocabulary_' + data_name + '.txt'
    # output_path = 'vovab_zinc250.txt'
...
# dataname = 'vocab_zinc_250k'
# data = pd.read_csv('/home/ntu/PycharmProjects/T-KG/MSSGAT-main/code/dataset/zinc15_250K_2D.csv')
# result = get_Vocab_df(dataname,data)
